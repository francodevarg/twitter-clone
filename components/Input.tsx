...
//   const { data: session } = useSession();
  ...
  return (
    <div
      className={`flex space-x-3 overflow-hidden border-b border-gray-200 p-3`}
    >
      <img
        src={
          'https://yt3.ggpht.com/yti/APfAmoFEvwA525FagnnvCJ7dcCmwp2P1AOLWo9yBCzgVzO8=s88-c-k-c0x00ffffff-no-rj-mo'
        }
      ...
      <div className="w-full divide-y divide-gray-200">
        <div className={``}>
          <textarea
            className="min-h-[50px] w-full bg-transparent text-lg tracking-wide text-gray-700 placeholder-gray-500 outline-none"
